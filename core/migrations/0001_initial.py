# Generated by Django 5.2.3 on 2026-04-25 12:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_qualifications', to='core.employee')),
                ('qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employee_qualifications', to='core.qualification')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('employee_qualification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_modifiers', to='core.employeequalification', verbose_name='Квалификация сотрудника')),
        ...
        migrations.AddField(
            model_name='cargo',
            name='current_slot',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cargo', to='core.locationslot'),
        ),
        migrations.AddField(
            model_name='employee',
            name='qualifications',
            field=models.ManyToManyField(blank=True, related_name='employees', through='core.EmployeeQualification', to='core.qualification'),
        ),
        migrations.CreateModel(
            name='Shift',
            fields=[
        ...
        migrations.AddField(
            model_name='cargo',
            name='sku',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cargos', to='core.sku'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_type', models.CharField(choices=[('inbound', 'Зона приёмки'), ('staging', 'Зона временного хранения'), ('rack', 'Зона длительного хранения'), ('pick', 'Отборочная зона'), ('outbound', 'Зона отгрузки'), ('qc', 'Зона контроля качества')], default='rack', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.CharField(choices=[('RECEIVE_TO_INBOUND', 'Receive to inbound'), ('PUTAWAY_TO_RACK', 'Putaway to rack'), ('MOVE_BETWEEN_SLOTS', 'Move between slots'), ('DISPATCH_CARGO', 'Dispatch cargo'), ('GENERAL', 'GENERAL TASK')], db_index=True, max_length=40)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['employee_qualification'], name='core_employ_employe_de05f3_idx'),
        ),
        migrations.AddIndex(
            model_name='employeetaskqualificationmodifier',
        ...
        migrations.AddConstraint(
            model_name='employeetaskqualificationmodifier',
            constraint=models.UniqueConstraint(fields=('profile', 'employee_qualification'), name='uniq_profile_employee_qualification_modifier'),
        ),
        migrations.AddIndex(
            model_name='cargoevent',
            index=models.Index(fields=['event_type', 'timestamp'], name='core_cargoe_event_t_84ca8c_idx'),
        ),
        migrations.AddIndex(
            model_name='cargoevent',
            index=models.Index(fields=['cargo', 'timestamp'], name='core_cargoe_cargo_i_25b21c_idx'),
        ),
        migrations.AddIndex(
            model_name='employeequalification',
            index=models.Index(fields=['employee', 'qualification'], name='core_employ_employe_7319bc_idx'),
        ),
        migrations.AddIndex(
            model_name='employeequalification',
            index=models.Index(fields=['qualification'], name='core_employ_qualifi_c835cd_idx'),
        ),
        migrations.AddConstraint(
            model_name='employeequalification',
            constraint=models.UniqueConstraint(fields=('employee', 'qualification'), name='uniq_employee_qualification'),
        ),
        migrations.AddIndex(
            model_name='employee',
