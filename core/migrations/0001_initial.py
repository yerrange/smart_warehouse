# Generated by Django 5.2.3 on 2025-09-22 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container_type', models.CharField(choices=[('pallet', 'Pallet'), ('crate', 'Crate'), ('drum', 'Drum'), ('box', 'Box'), ('tote', 'Tote')], default='pallet', max_length=16)),
                ('units', models.PositiveIntegerField(default=1)),
                ('weight_kg', models.FloatField(default=0)),
                ('volume_m3', models.FloatField(default=0)),
                ('status', models.CharField(choices=[('arrived', 'Поступил'), ('stored', 'Размещён'), ('processing', 'Обработка'), ('dispatched', 'Отгружен')], db_index=True, default='arrived', max_length=16)),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('employees', models.ManyToManyField(related_name='shifts', through='core.EmployeeShiftStats', to='core.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_type', models.CharField(choices=[('receiving', 'Receiving dock'), ('staging', 'Staging area'), ('rack', 'Rack/bin'), ('pick', 'Pick face'), ('outbound', 'Outbound dock'), ('qc', 'Quality control')], default='rack', max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event_type', models.CharField(choices=[('arrived', 'Поступление'), ('stored', 'Размещение'), ('moved', 'Перемещение'), ('picked', 'Отбор'), ('dispatched', 'Отгрузка'), ('qc', 'Контроль'), ('note', 'Заметка')], max_length=16)),
                ('timestamp', models.DateTimeField(auto_now_add=True, db_index=True)),
        ...
        migrations.AddIndex(
            model_name='cargo',
            index=models.Index(fields=['sku'], name='core_cargo_sku_019a9f_idx'),
        ),
