...
TASK_ASSIGNER_BALANCE_COMPLETED_WEIGHT = float(
    os.getenv("TASK_ASSIGNER_BALANCE_COMPLETED_WEIGHT", "0.10")
)
TASK_ASSIGNER_BALANCE_SCORE_WEIGHT = float(
    os.getenv("TASK_ASSIGNER_BALANCE_SCORE_WEIGHT", "0.25")
)
TASK_ASSIGNER_BALANCE_MAX_PENALTY = float(
    os.getenv("TASK_ASSIGNER_BALANCE_MAX_PENALTY", "0.35")
)
