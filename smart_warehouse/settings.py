...
TASK_ASSIGNER_LOG_TOPK = int(os.getenv("TASK_ASSIGNER_LOG_TOPK", "3"))

TASK_ASSIGNER_BALANCE_ASSIGNED_WEIGHT = float(
    os.getenv("TASK_ASSIGNER_BALANCE_ASSIGNED_WEIGHT", "0.20")
)
TASK_ASSIGNER_BALANCE_COMPLETED_WEIGHT = float(
    os.getenv("TASK_ASSIGNER_BALANCE_COMPLETED_WEIGHT", "0.05")
)
TASK_ASSIGNER_BALANCE_SCORE_WEIGHT = float(
    os.getenv("TASK_ASSIGNER_BALANCE_SCORE_WEIGHT", "0.30")
)
TASK_ASSIGNER_BALANCE_MAX_PENALTY = float(
    os.getenv("TASK_ASSIGNER_BALANCE_MAX_PENALTY", "0.45")
)



# TASK_ASSIGNER_BALANCE_ASSIGNED_WEIGHT = float(
#     os.getenv("TASK_ASSIGNER_BALANCE_ASSIGNED_WEIGHT", "0.0")
# )
# TASK_ASSIGNER_BALANCE_COMPLETED_WEIGHT = float(
#     os.getenv("TASK_ASSIGNER_BALANCE_COMPLETED_WEIGHT", "0.0")
# )
# TASK_ASSIGNER_BALANCE_SCORE_WEIGHT = float(
#     os.getenv("TASK_ASSIGNER_BALANCE_SCORE_WEIGHT", "0.0")
# )
# TASK_ASSIGNER_BALANCE_MAX_PENALTY = float(
#     os.getenv("TASK_ASSIGNER_BALANCE_MAX_PENALTY", "0.0")
# )
